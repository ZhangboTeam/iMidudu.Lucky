...
* 2.非必要，禁止用行内样式例如 <div style="display:block"> 
 -->
    ...
    <%
        var returnUrl = string.Format("http://lucky.meduo.com.cn/Alps61/Ticket3.aspx?QRCode={0}", this.Request["QRCode"]);
...
<div class="container"><!-- Everything started here -->
	<div class="mtx-price-detail">
		<div class="inner">
			<ul>
				<li>买任意数量预包装阿尔卑斯棒棒糖、珍宝珠、比巴卜产品均可参加活动（需向促销员提交购物小票），详询店内促销员</li>
				<li>幸运大奖：乐高益智玩具市场参考价值499元，全国限量50份，中奖比率0.01%</li>
				<li>所有奖品以实物为准，奖品的价值以举办活动时的市场参考价值为准，本公司保留因兑奖时因奖品停产或其他特殊原因以相同价值物品更换已公布奖品之权利</li>
				<li>幸运大奖通过微信扫二维码参加抽奖，现场开奖；奖品将在三周内以市内快递形式寄出，快递范围仅限于本市范围内；</li>
				<li>请抽中幸运大奖的中奖者留下收件地址和联系方式；因中奖者提供的收件地址错误或该地址无法投递/发送奖品的，将视为中奖者自动放弃获奖资格，将不会获得任何形式的补偿</li>
				<li>每个微信账号限中奖一次</li>
